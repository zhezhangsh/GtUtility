### Perform a run of one or multiple pairwise sample group comparisons, using a genotyping data set, at variant, gene, and 
runComparison<-function(inputs) {
  # inputs: The full path to a yaml file or list including the elements as in the following example

if (FALSE) { # all code in this block is comment
---
